...
ClapTrap::ClapTrap( std::string name, unsigned int hitPts, unsigned int energyPts,
      unsigned int attackDmg) : _name(name), _hitPoints(hitPts), _energyPoints(energyPts),
                             _attackDamage(attackDmg) {
  std::cout << "ClapTrap full parametrized constructor called" << std::endl;
}
...
void ClapTrap::setHitPoints(unsigned int hitPts){

  this->_hitPoints = hitPts;

}

void ClapTrap::setEnergyPoints(unsigned int energyPts){

  this->_energyPoints = energyPts;

}

void ClapTrap::setAttackDamage(unsigned int attackDmg){

  this->_attackDamage = attackDmg;
